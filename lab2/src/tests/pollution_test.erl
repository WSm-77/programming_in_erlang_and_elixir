...
%%% @doc/home/wiktor/university/sem4/erlang_elixir/lab2
...
get_station_min_test() ->
  ...
  M1 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,10}}, "PM10", 2000, M),
  M2 = pollution:add_value("Stacja 2", {{2023,3,27},{11,16,11}}, "PM10", 20, M1),
  M3 = pollution:add_value("Stacja 1", {{2023,3,27},{11,16,12}}, "PM10", 3000, M2),
  ...
  M7 = pollution:add_value("Stacja 1", {{2023,3,28},{11,16,16}}, "PM10", 10, M6),
  ...
  ?assertMatch(2000, pollution:get_station_min("Stacja 1", "PM10", M2)),
  ?assertMatch(2000, pollution:get_station_min("Stacja 1", "PM10", M6)),
  ?assertMatch(10, pollution:get_station_min("Stacja 1", "PM10", M9)).
...
get_station_min_fail_test() ->
  ...
  ?assertMatch({error, _}, pollution:get_station_min("Stacja 1", "PM25", M2)),
  ?assertMatch({error, _}, pollution:get_station_min("Stacja 3", "PM10", M2)).
...
%%  ?assertMatch(15.0, pollution:get_daily_mean("PM10",{2023,3,27}, M9)).   %% incorrect test case
