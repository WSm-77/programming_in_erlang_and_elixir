...
%%  M2 = pollution_server:add_value("Stacja 1", Time, "PM1", 46.3, M1),
%%  M3 = pollution_server:add_value("Stacja 1", {{2023,3,27},{11,16,9}}, "PM10", 46.3, M2),
%%
%%  M4 = pollution_server:remove_value("Stacja 1", Time, "PM10", M3),
%%  ?assertNotMatch({error, _}, M4),
%%  ?assertNotEqual(M4, M3),
%%  M5 = pollution_server:remove_value("Stacja 1", {{2023,3,27},{11,16,9}}, "PM10", M4),
...
%%  M3 = pollution_server:add_value("Stacja 1", {{2023,3,27},{11,16,9}}, "PM10", 46.3, M2),
%%
%%  M4 = pollution_server:remove_value("Stacja 1", {{2023,3,27},{11,16,9}}, "PM10", M3),
%%  ?assertNotEqual(M4, M3),
%%
%%  M5 = pollution_server:add_value({1,1}, {{2023,3,27},{11,16,9}}, "PM10", 46.3, M4),
%%  ?assertEqual(M5, M3).
%%
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%  M3 = pollution_server:add_value("Stacja 1", {{2023,3,27},{11,16,9}}, "PM10", 46.3, M2),
%%
%%  ?assertMatch({error, _}, pollution_server:remove_value("Stacja 1", Time, "PM25", M3)),
%%  ?assertMatch({error, _}, pollution_server:remove_value("Stacja 1", {{2023,3,27},{11,16,10}}, "PM10", M3)),
%%  ?assertMatch({error, _}, pollution_server:remove_value({1,2}, Time, "PM10", M3)),
%%  ?assertMatch({error, _}, pollution_server:remove_value("Stacja 2", Time, "PM10", M3)).
%%
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%get_one_value_test() ->
...
%%  M2 = pollution_server:add_value("Stacja 1", {{2023,3,27},{11,16,11}}, "PM10", 20, M1),
%%  M3 = pollution_server:add_value("Stacja 1", {{2023,3,27},{11,16,12}}, "PM10", 10, M2),
%%  M4 = pollution_server:add_value("Stacja 1", {{2023,3,27},{11,16,13}}, "PM10", 20, M3),
%%
%%  ?assertMatch(15.0, pollution_server:get_station_mean("Stacja 1", "PM10", M2)),
%%  ?assertMatch(15.0, pollution_server:get_station_mean({1,1}, "PM10", M4)),
%%  ?assertMatch(40/3, pollution_server:get_station_mean("Stacja 1", "PM10", M3)).
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
...
%%  M1 = pollution_server:add_value("Stacja 1", {{2023,3,27},{11,16,10}}, "PM10", 2000, M),
%%  M2 = pollution_server:add_value("Stacja 2", {{2023,3,27},{11,16,11}}, "PM10", 20, M1),
%%  M3 = pollution_server:add_value("Stacja 1", {{2023,3,27},{11,16,12}}, "PM10", 3000, M2),
...
%%
%%  M7 = pollution_server:add_value("Stacja 1", {{2023,3,28},{11,16,16}}, "PM10", 10, M6),
...
%%
%%  ?assertMatch(2000, pollution_server:get_station_min("Stacja 1", "PM10", M2)),
%%  ?assertMatch(2000, pollution_server:get_station_min("Stacja 1", "PM10", M6)),
%%  ?assertMatch(10, pollution_server:get_station_min("Stacja 1", "PM10", M9)).
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%  ?assertMatch({error, _}, pollution_server:get_station_min("Stacja 1", "PM10", M)),
%%  M1 = pollution_server:add_value("Stacja 1", {{2023,3,27},{11,16,10}}, "PM10", 10, M),
%%  M2 = pollution_server:add_value("Stacja 2", {{2023,3,27},{11,16,11}}, "PM10", 20, M1),
%%
%%  ?assertMatch({error, _}, pollution_server:get_station_min("Stacja 1", "PM25", M2)),
%%  ?assertMatch({error, _}, pollution_server:get_station_min("Stacja 3", "PM10", M2)).
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
